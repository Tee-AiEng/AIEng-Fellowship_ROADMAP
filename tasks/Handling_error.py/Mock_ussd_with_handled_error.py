...
if Ussd.strip() != "*297#":
    ...
    while True:
        ...
        if choice == "1":
            ...
            if opt == "1":
                ...
                if opt == "1":
                    try:
                        ...
                        print("Are you sure?\n1.\tYes\n2.\tNo")
                        optin = input("Enter your option: ").strip()
                        if optin == "1":
                ...
                if opt == "1":
                    ...
                    print("5. #5000 - 17gb")
                    try:
                        amount = int(input("Enter amount in gb: "))
                    except ValueError:
                            print("Invalid amount entered.")
                    print("Are you sure?\n1.\tYes\n2.\tNo")
                    optin = input("Enter your option: ").strip()
                    if optin == "1":
                        print(f"Your line has been credited with {amount}gb. Thank you for using our services\nPress 5 to exit")
                    else:
                        print("Select a new option on the mainmenu.")
                elif opt == "2":
                    number = input("Enter the number: ")
                    ...
                    if proceed == "1":
                        ...
                        print("5. #5000 - 17gb")
                        try:
                            amnt = int(input("Enter amount in gb: "))
                        except ValueError:
                            print("Invalid amount entered.")
                        print(f"The {number} has been credited with {amnt}. Thank you for using our services\nPress 5")
                    else:
            ...
            if opt == "1":
                try:
                    amount = int(input("Enter amount to share: "))     
                except ValueError:
