while True:
    ...
    if choice == "1":
        try:
            ...
            print("Invalid input. Enter integer instead")
        if jamb_score >= 200:
        ...
        try:
            ...
            print("Invalid input. Enter integer instead")
        print("Please note write university name or acronym")
        ...
        try:
            Utme_screening = int(input("Enter option: "))
        except ValueError:
            print("Invalid input. Enter integer instead")
        try:
        ...
        if (age >= 16) and (jamb_score >= 200) and ( university_choice in ["UNIVERSITY OF LAGOS","UNILAG"]) and ( Utme_screening == "1") and ("Mathematics" in O_level_requirement) and ("English" in O_level_requirement) and (O_level_score >= 45) and (dept_cut_off >= 200):
